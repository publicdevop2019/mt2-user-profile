...
//
//    @Mock
//    AppBizOrderScheduler orderApplicationService;
//
//    /**
...
//        Mockito.doReturn(mock).when(orderApplicationService).createNew(anyString(), anyLong(),anyLong(), any(UserCreateBizOrderCommand.class));
//        Mockito.doReturn("mock").when(mock).getPaymentLink();
//        ResponseEntity<Void> voidResponseEntity = orderController.reserveOrder(rJwt(), rLong(),rLong(), new UserCreateBizOrderCommand());
...
//        BizOrderPaymentLinkRepresentation mock = Mockito.mock(BizOrderPaymentLinkRepresentation.class);
//        Mockito.doReturn(mock).when(orderApplicationService).reserveAgain(anyString(), anyLong(), anyLong(), any(UserPlaceBizOrderAgainCommand.class));
//        Mockito.doReturn("").when(mock).getPaymentLink();
//        ResponseEntity<Void> voidResponseEntity = orderController.reserveAgain(rJwt(), rLong(), rLong(), new UserPlaceBizOrderAgainCommand());
//        Assert.assertNotNull(voidResponseEntity.getHeaders().getLocation());
//    }
//
//    @Test
